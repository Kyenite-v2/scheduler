                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {user.verified ? <Badge variant="secondary" className="bg-blue-600 flex flex-wrap items-center gap-2 text-white"><BadgeCheck data-icon="inline-start" /> verified</Badge> : <Badge variant="outline" className="flex flex-wrap items-center gap-2"><BadgeX data-icon="inline-start" />unverified</Badge>}
                        </div>
